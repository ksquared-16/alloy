...
- Platform docs (`docs/platform/core/*`, `docs/system/*`, `docs/platform_convergence/*`)
...
| `docs/platform_convergence/field_catalog_convergence_audit.md` | 17-system field inventory (June 2026) |
...
- `docs/platform_convergence/field_catalog_convergence_audit.md`
- `docs/sprints/05_2026/canonical_action_catalog_v1.md`
...
| Item | Result |
|------|--------|
| Formal doctrine | `docs/canonical-data-system.md` + 8 specification docs |
| Field catalog | Generated — `docs/canonical-field-catalog.md` (100 rows) |
...
```
docs/canonical-data-system.md (hub)
├── canonical-entity-specification.md
├── canonical-status-architecture.md
├── canonical-field-catalog.md (generated)
├── universal-field-system.md
├── canonical-relationship-model.md
├── canonical-action-status-field-matrix.md
├── canonical-runtime-data-alignment.md
└── canonical-configuration-data-alignment.md
```
