...
- /docs/UI_VISION_AND_DOCTRINE.md
- /docs/INFORMATION_ARCHITECTURE.md
- /docs/INTERFACE_ARCHITECTURE.md
- /docs/AI_INTERACTION_MODEL.md
- /docs/UI_COMPONENT_SYSTEM.md

Do not proceed with high-level design decisions without checking these files.
...
“Using /docs/UI_VISION_AND_DOCTRINE.md, /docs/INFORMATION_ARCHITECTURE.md, and /docs/UI_COMPONENT_SYSTEM.md, implement the Phase 1 App Shell only. Do not invent additional navigation patterns. Keep the sidebar collapsed by default, include top search, perspective tabs, a center canvas placeholder, hidden right inspector panel, and pinned bottom AI command bar.”
