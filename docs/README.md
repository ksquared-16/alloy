...
- **Active June 2026:** **`docs/sprints/06_2026/`** — lifecycle runtime/configuration alignment (runtime shipped). **Configuration UX (spec only, no hub build in sprint):** audit **`enrollment_operations_configuration_ux_audit.md`** · hub spec **`enrollment_process_configuration_hub_spec_v1.md`**.
