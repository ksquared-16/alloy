...
| `system/`    | `entity-model.md`, `actions-and-workflows.md`, `record-system.md`, `workspace-system.md`, **`queue-record-doctrine.md`**, **`typography-and-presentation-doctrine.md`**, `roles-and-permissions.md`, `configuration-system.md`, `api-contracts.md`, **`adminv2-runtime-performance-doctrine.md`** |
...
6. **`system/workspace-system.md`** — Departments, work units, queues, Admin V2 workspace; needs-attention count semantics. **Queue row contract (locked):** **`system/queue-record-doctrine.md`**. **Presentation contract (locked):** **`system/typography-and-presentation-doctrine.md`**. **Runtime performance doctrine (locked):** **`system/adminv2-runtime-performance-doctrine.md`**.
