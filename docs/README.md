...
- **Active June 2026:** **`docs/sprints/06_2026/`** — lifecycle runtime/configuration alignment (runtime shipped). **Enrollment Process hub:** `/adminV2/settings/enrollment-process` · editable status↔stage binding **`enrollment_status_stage_binding_reality_check_v1.md`** · architecture **`process_builder_architecture_reality_check_v1.md`** · UX audit **`enrollment_operations_configuration_ux_audit.md`** · spec **`enrollment_process_configuration_hub_spec_v1.md`**.
