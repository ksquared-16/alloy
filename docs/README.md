...
- **Forms intelligence + document infrastructure (May 2026):** **`docs/sprints/05_2026/forms_intelligence_document_infrastructure.md`** — **FD-1–FD-7** shipped (filters, submission compression, composition foundation, embed + AI recreation doctrine); builds on OW/OI.
