...
- **Lifecycle runtime & configuration alignment (May 2026):** **`docs/sprints/06_2026/lifecycle_runtime_configuration_alignment_sprint.md`** — planning sprint (no implementation): action placement audit, Settings alignment audit, P0 backlog, implementation order. **Runtime matrix:** **`docs/sprints/06_2026/lifecycle_runtime_alignment_matrix_v1.md`**. Follows closed Lifecycle Configuration & Requirement Engine sprint (`lifecycle_sprint_final_coverage_closeout_audit_v1.md`).
...
- **Active June 2026:** **`docs/sprints/06_2026/`** — lifecycle runtime/configuration alignment, action button UX.
