...
- **Active June 2026:** **`docs/sprints/06_2026/`** — lifecycle runtime/configuration alignment, action button UX. **Enrollment Operations UX audit (no implementation):** **`docs/sprints/06_2026/enrollment_operations_configuration_ux_audit.md`** — unified Lead → Enrolled mental model; Lifecycle vs Work Units vs Fields ownership.
