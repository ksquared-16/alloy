...
| [`POS-F01-foundation-analysis.md`](./POS-F01-foundation-analysis.md) | Foundation Gate: reuse/extension analysis across 7 foundations, dependency map, risks. Which existing Alloy systems become the POS implementation foundation. |
| [`POS-F02-processing-case-foundation.md`](./POS-F02-processing-case-foundation.md) | Conceptual foundation of Source, Processing Case, Review, Resolution, Outcome — incl. multi-source, confidence model, vocabulary, approval-only V1. |
| [`POS-F03-build-sequence.md`](./POS-F03-build-sequence.md) | What to build first / second / defer, aligned to POS-A03. Conceptual, no package plans. |
| [`POS-F04-forms-field-registry-binding-seam.md`](./POS-F04-forms-field-registry-binding-seam.md) | Code-grounded investigation: where Forms still define fields in JSON, the existing `field_source.field_key` binding seam, the minimum registry binding for POS V1, legacy support, forbidden new JSON, and Foundation Package 0 scope. |
| [`POS-FP0-field-registry-binding-package.md`](./POS-FP0-field-registry-binding-package.md) | First execution package plan (planning only): enforce the `field_source.field_key` binding for POS-connected surfaces. Objective, files likely touched, risks, test plan, substitute gate, acceptance, rollback, must-not-happen. |
| [`POS-FP1-processing-case-envelope-package.md`](./POS-FP1-processing-case-envelope-package.md) | Second execution package plan (planning only): the thin Processing Case envelope + source reference model + POS-connected form/packet on-ramp. Includes the minimal additive migration proposal (2 tables), lifecycle fields, tests/gates, rollback, must-not-happen, out of scope. |
| [`POS-FP2-processing-case-read-model-package.md`](./POS-FP2-processing-case-read-model-package.md) | Read-model foundation package plan (planning only): make Processing Cases queryable (queue rows + detail) without copying source payloads. Read model definition, query/sort/filter requirements, denormalize-vs-resolve-live, source display resolvers, minimal additive indexes, reuse-FP1-schema, tests/gates, rollback, must-not-happen. |
| [`POS-FP3-processing-workspace-queue-package.md`](./POS-FP3-processing-workspace-queue-package.md) | First visible POS surface package plan (planning only): the read-only Processing Workspace queue consuming FP2. Route/nav, columns, filters, status lanes, source descriptors, future row-open, Work Unit patterns to reuse; objective/UX/architecture/files/migration/risks/tests/gates/acceptance/rollback/must-not-happen. |
| [`POS-FP4-processing-case-detail-package.md`](./POS-FP4-processing-case-detail-package.md) | Processing Case Detail package plan (planning only): the read-only detail drawer from `/admin/processing` proving Case-as-hero / sources-as-evidence / records-own-truth / proposed-values-visible-not-promoted. Carries FP3-audit findings (drawer host, approved queue index, deferred visual debt); UX/architecture/files/migration/risks/tests/gates/acceptance/rollback/must-not-happen. |
