...
| Enrollment pipeline canonical | [canonical_enrollment_operating_model_seed.md](./canonical_enrollment_operating_model_seed.md), `web/lib/config/enrollmentPipelineQueueDefinitionV1.ts` |
