...
**Staging baseline:** `cacec5bea` — lifecycle + entities adoption merge on `f1c87c31b`
...
```
cacec5bea95f9c0a3ccc07217af3804cad3c182e
```

| Artifact | Hash |
| --- | --- |
| **Final staging** | `cacec5bea` — merge `feat/data-model-lifecycle-entities` onto `f1c87c31b` |
