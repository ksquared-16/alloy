...
| SC-1 Generalize subject contract | Scalability | High | — | ✓ | **IP** — platform model subject generalized + PoC (see §1c re-sequenced row); provisioning snapshot = Leak 2C (reveal-path) |
