...
> **Doctrine (2026-04):** Current **identity and relationship direction** (persons canonical, contacts sunset as first-class path, layered relationship storage) is summarized in [`docs/architecture/relationship-and-identity-doctrine.md`](../architecture/relationship-and-identity-doctrine.md). This file remains a **point-in-time implementation audit** with file-level references for migration planning.
