# Workspace V2 — implementation docs

Concrete behavior for **Admin V2 workspace** routes, **visual context**, and **Needs Attention**. These complement (do not replace) [`../../architecture/README.md`](../../architecture/README.md).
