...
See **`docs/implementation/ADMIN_API_REMEDIATION_BATCH_3.md`** for workflows, entity drawer GET, vendor contacts/signed URL, schedule/job assign helpers, subscriptions generate-next, payments/run guard, and dashboard SSR org scoping.
...
See `docs/audits/ADMIN_API_ORG_SCOPING_AUDIT_V1.md` **Remediation** column for per-route status.
