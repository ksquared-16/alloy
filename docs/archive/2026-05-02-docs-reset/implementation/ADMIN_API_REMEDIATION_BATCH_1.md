...
Batch 2 remediation is documented in **`docs/implementation/ADMIN_API_REMEDIATION_BATCH_2.md`** (payments, workflow env-org routes, pipeline/vertical id routes, discount redemptions, PATCH IDOR on customers/opportunities/vendors/payments).
