...
**Terminology:** **Admin action** refers to UI/system-triggered admin operations; **workflow action** refers to an ordered step executed inside workflow runs. Disambiguation: **`docs/platform/governance/glossary.md`** (canonical); expanded terms in **`docs/platform/governance/glossary.md`** (transitional).
...
Sprint audit: `docs/sprints/archive/06_2026/action_button_configuration_ux_sprint.md`.
...
Closeout: **`docs/sprints/archive/05_2026/completed/settings_control_plane_closeout.md`**.
...
- **Status labels vs automation:** Display names — **Settings → Statuses**. Condition-driven status updates (e.g. tour date set → Tour Scheduled) — **Automations** / workflows; read-only reference table **Workflow automation rules** (`status_transition_rules`). Custom handlers — deferred to automation builder (`docs/sprints/archive/05_2026/completed/settings_control_plane_closeout.md`).
