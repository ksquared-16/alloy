...
Organization Runtime V2 freezes Organization as publisher and Locations as consumers. Its responsive Configuration Domain Cards are runtime objects that expose identity, publication, consumers, inheritance, overrides, and health; they are not dashboard widgets. The nine-domain registry includes Programs, Automation, and Operational Intelligence as distinct owners. See `../../system/organization-configuration-runtime-v2.md`.
