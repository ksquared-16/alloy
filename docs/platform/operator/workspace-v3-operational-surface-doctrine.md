...
**Evolution constraint:** `sprint-3-evolution-reset.md` (historical: `../../sprints/archive/06_2026/workspace-v3-operational-command-center/sprint-3-evolution-reset.md`) — tile **shell** frozen; inner content evolves  
...
Full audit: `sprint-4-ux-continuity.md` (historical: `../../sprints/archive/06_2026/workspace-v3-operational-command-center/sprint-4-ux-continuity.md`)

---

## 10. Configuration (design for — not implement)

See `sprint-2-evolution.md` § Configuration architecture (historical: `../../sprints/archive/06_2026/workspace-v3-operational-command-center/sprint-2-evolution.md`).
