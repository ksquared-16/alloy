...
**Related:** [`alloy-runtime-specification.md`](./alloy-runtime-specification.md) · [`alloy-os-runtime-completion.md`](./alloy-os-runtime-completion.md) · [`queue-system.md`](./queue-system.md) · [`operational-surface-design-system.md`](./operational-surface-design-system.md) (System 5) · [`runtime-surface-section-map.md`](./runtime-surface-section-map.md) (section ids + reveal/blocking diagnostics) · [`surface-view-model-composition.md`](./surface-view-model-composition.md) (per-route Surface ViewModel ownership)
