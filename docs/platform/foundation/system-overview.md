...
**Onboarding:** [`alloy-platform-handbook.md`](./alloy-platform-handbook.md) teaches the platform; this overview and the rest of `docs/platform/` are the encyclopedia.
