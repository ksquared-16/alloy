...
| R10 | Entity search disambiguation | [taskAssistEntitySearchService.ts](../../../../web/lib/agent/taskAssist/taskAssistEntitySearchService.ts) (689 ln), `web/lib/admin/globalSearch/` + `web/lib/search/searchRanking.ts` (the former `globalRecordSearchService.ts`, since split) (683 ln) | "Which record did they mean?" | Ranking + dedupe + disambiguation | ephemeral |
...
| **M11** | Search result ranking | `web/lib/admin/globalSearch/` + `web/lib/search/searchRanking.ts` (the former `globalRecordSearchService.ts`, since split), [taskAssistEntitySearchService.ts](../../../../web/lib/agent/taskAssist/taskAssistEntitySearchService.ts) | ephemeral | none | Global search, BOS entity resolution | **Phase 5** | Decision Package when semantic; deterministic retrieval stays uncontracted |
