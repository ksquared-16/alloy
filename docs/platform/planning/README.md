...
- **[mockups/scheduling-children-composition.html](./mockups/scheduling-children-composition.html)** — *(final)* the Children ↔ Scheduling composition: the two peer cards (configurable Children + platform Scheduling), the multi-schedule timeline (current · temporary · future · history), the pattern editor, rates & projected tuition, and household navigation.
