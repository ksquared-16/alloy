...
> **Layer:** Attendance is **L4 Operational Facts** in [`../operational-truth-flow-doctrine.md`](../operational-truth-flow-doctrine.md). It is compared against **L3 Expectations** (expected attendance) and feeds **L5 Consequences** (billing). It is recorded from the Operations plane and reviewed from the Records plane (see [`../operational-ux-doctrine.md`](../operational-ux-doctrine.md)).
...
- **Expected attendance is computed**, never stored as a system of record. See [`../operational-truth-flow-doctrine.md`](../operational-truth-flow-doctrine.md) (L3).
...
- **Records plane:** the child drawer gains an **Attendance** tab once attendance history exists. Following [`../operational-ux-doctrine.md`](../operational-ux-doctrine.md): the tab is **Active** when facts exist; before any history, "Record attendance / Mark present" is offered as a **Startable action** — a hidden tab must never hide the path to begin valid work.
...
**RefKey namespace** — entity type `child_attendance_events` (per [child namespace §6](../../platform_convergence/child_namespace_decision.md); surfaced later via an attendance-child context). Does not reuse `inquiry_child.*`.
...
| Concern | Doctrine |
|---------|----------|
| Truth-flow layers (Attendance = L4) | [`../operational-truth-flow-doctrine.md`](../operational-truth-flow-doctrine.md) |
| Surface planes, progressive drawer, tabs vs actions | [`../operational-ux-doctrine.md`](../operational-ux-doctrine.md) |
| Committed enrollment foundation (what attendance references) | [`../core/placement-system.md`](../core/placement-system.md) |
| Child namespace per module | [`../../platform_convergence/child_namespace_decision.md`](../../platform_convergence/child_namespace_decision.md) |
