...
|-----------|-------|--------------|--------------|---------------|-----------|------------|-------------|--------|---------|-----------------|-----------|--------|----------------|
| age | Age | child | customer_members | dob | text | text | computed | no | yes | layout / drawer | derived projection | computed | child.age |
...
| full_name | Full name | child | customer_members | first_name | text | text | computed | no | yes | layout / drawer | derived projection | computed | child.full_name |
...
| program_category_id | Program | inquiry_child | opportunity_customer_members | program_category_id | select | select | editable | yes | yes | lifecycle / field_rules | canonical entity row | native | inquiry_child.program_category_id |
...
| schedule_type | Schedule | inquiry_child | opportunity_customer_members | schedule_type | select | select | editable | yes | yes | lifecycle / field_rules | canonical entity row | native | inquiry_child.schedule_type |
| start_date | Start date | inquiry_child | opportunity_customer_members | start_date | date | date | editable | yes | yes | lifecycle / field_rules | canonical entity row | native | inquiry_child.start_date |
...
| billing_address_city | Billing contact city | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_address_city |
| billing_address_line1 | Billing contact address line 1 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_address_line1 |
| billing_address_line2 | Billing contact address line 2 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_address_line2 |
| billing_address_postal_code | Billing contact ZIP code | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_address_postal_code |
| billing_address_state | Billing contact state | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_address_state |
| billing_contact_email | Billing contact email | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_contact_email |
| billing_contact_name | Billing contact name | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.billing_contact_name |
| billing_contact_phone | Billing contact phone | parent | opportunities | primary_person_id | phone | phone | computed | no | yes | layout / drawer | derived projection | computed | person.billing_contact_phone |
| emergency_address_city | Emergency contact city | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_address_city |
| emergency_address_line1 | Emergency contact address line 1 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_address_line1 |
| emergency_address_line2 | Emergency contact address line 2 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_address_line2 |
| emergency_address_postal_code | Emergency contact ZIP code | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_address_postal_code |
| emergency_address_state | Emergency contact state | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_address_state |
| emergency_contact_email | Emergency contact email | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_contact_email |
| emergency_contact_name | Emergency contact name | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_contact_name |
| emergency_contact_phone | Emergency contact phone | parent | opportunities | primary_person_id | phone | phone | computed | no | yes | layout / drawer | derived projection | computed | person.emergency_contact_phone |
| is_primary_contact | Is primary contact | parent | — | is_primary_contact | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.is_primary_contact |
| primary_address_city | Primary contact city | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_address_city |
| primary_address_line1 | Primary contact address line 1 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_address_line1 |
| primary_address_line2 | Primary contact address line 2 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_address_line2 |
| primary_address_postal_code | Primary contact ZIP code | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_address_postal_code |
| primary_address_state | Primary contact state | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_address_state |
| primary_contact_name | Primary contact name | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.primary_contact_name |
| secondary_address_city | Secondary contact city | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_address_city |
| secondary_address_line1 | Secondary contact address line 1 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_address_line1 |
| secondary_address_line2 | Secondary contact address line 2 | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_address_line2 |
| secondary_address_postal_code | Secondary contact ZIP code | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_address_postal_code |
| secondary_address_state | Secondary contact state | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_address_state |
| secondary_contact_name | Secondary contact name | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_contact_name |
| secondary_email | Secondary contact email | parent | opportunities | primary_person_id | text | text | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_email |
| secondary_phone | Secondary contact phone | parent | opportunities | primary_person_id | phone | phone | computed | no | yes | layout / drawer | derived projection | computed | person.secondary_phone |
