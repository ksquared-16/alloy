...
**Status:** PROPOSED architecture (design only; no code, no migrations). Governs convergence of Location · Program · Room · Capacity · Ratio · Timezone into one canonical operational domain.
