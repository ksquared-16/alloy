...
- **Waitlist demo readiness (May 2026 — closed):** `waitlist_demo_v1` cleanup/reseed, person drawer doctrine, Settings locations hierarchy, demo walkthrough QA — **`docs/sprints/05_2026/waitlist_demo_readiness_final_pass.md`**.
