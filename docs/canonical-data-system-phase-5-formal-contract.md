...
| Document | Purpose |
|----------|---------|
| `docs/canonical-data-system.md` | Permanent hub doctrine |
| `docs/canonical-entity-specification.md` | Entity ownership |
| `docs/canonical-status-architecture.md` | Status vs readiness vs attention layers |
| `docs/canonical-field-catalog.md` | Generated field inventory (100 rows) |
| `docs/universal-field-system.md` | Field type behavior spec |
| `docs/canonical-relationship-model.md` | Relationship edges |
| `docs/canonical-action-status-field-matrix.md` | Action/write matrix |
| `docs/canonical-runtime-data-alignment.md` | Runtime consumer contract |
| `docs/canonical-configuration-data-alignment.md` | Configuration consumer contract |
...
| `web/scripts/generateCanonicalFieldCatalogDoc.ts` | Emits `docs/canonical-field-catalog.md` |
...
See `docs/canonical-data-system.md` § Schema drop readiness.
