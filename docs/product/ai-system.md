...
| **Task Assist V1** | **`POST /api/admin/ai/task-assist/propose`**, **`POST /api/admin/ai/task-assist/apply`**, **`web/lib/agent/taskAssist/**`**, **`executeCommunicationsSend`**; UI gate **`taskAssistV1UiGate.ts`**; tests **`web/tests/agent/taskAssist/**`**; **`docs/sprints/05_2026/task_assist_v1.md`**. |
