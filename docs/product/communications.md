...
| Task Assist AdminV2 UI | `web/app/adminV2/components/aiCommandSurface/AICommandSurfaceShell.tsx`, `web/lib/agent/taskAssist/taskAssistCommandIntent.ts`, `web/contexts/GlobalAssistantContext.tsx`, `web/components/admin/taskAssist/TaskAssistOpportunityWorkspace.tsx`, `web/components/admin/taskAssist/TaskAssistOpportunityLauncher.tsx` |
