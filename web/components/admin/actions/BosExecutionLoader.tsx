...
/**
 * Canonical BOS execution loading treatment — neural pulse + phased assembly progress.
 * Reuse for Create Lead, Add Child, Schedule Tour, Send Welcome, Generate Document, BOS Recommendations.
 * Do not substitute spinners on these surfaces.
 */
