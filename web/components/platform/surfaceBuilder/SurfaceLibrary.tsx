...
import { surfaceLibraryByCategory, type SurfaceLibraryEntry } from "@/lib/platform/surfaceBuilder/surfaceLibrary";
        ...
        <div className="space-y-6" data-surface-library>
            <header>
                ...
                <p className="mt-1 text-sm text-alloy-midnight/55">
                    Every configurable surface in Alloy. Choose one to open the builder — the same builder powers them all.
                </p>
            </header>
