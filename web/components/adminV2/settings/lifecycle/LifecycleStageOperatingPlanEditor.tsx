...
import {
    BUSINESS_PROCESS_SECTION_OFF_TRACK,
...
import {
    STAGE_JOURNEY_SEGMENT_LABELS,
} from "@/lib/lifecycle/stageOperatingPlanUiLabels";
    ...
    return (
        <div className="space-y-3" data-testid="lifecycle-stage-operating-plan-editor">
            <p className="text-[11px] text-alloy-midnight/55">
                Define what staff should accomplish in this process stage. Operators choose outcomes when
                completing work — not raw status keys.
            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-3 text-[10px] text-alloy-midnight/65">
                                ...
                                <label className="flex items-center gap-1">
                                    ...
                                    <input
                                        ...
                                        value={
                                            work.due_policy.kind === "same_day"
                                                ? 0
                                                : work.due_policy.days ?? 1
                                        }
                                        onChange={(e) => {
            ...
            <div className="space-y-1.5">
                ...
                <ul className="space-y-1" data-testid="stage-operating-plan-outcome-list">
            ...
            {draft.attention_rules.length ? (
                <div className="space-y-1" data-testid="stage-operating-plan-attention-rules">
                    <span className="text-[11px] font-semibold text-alloy-midnight/75">
                        {BUSINESS_PROCESS_SECTION_OFF_TRACK}
                    </span>
                    <ul className="space-y-1 text-[11px] text-alloy-midnight/65">
