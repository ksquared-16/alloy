    ...
    return (
        <div className="flex w-full flex-col gap-3" data-testid="locations-landing">
            <div
                ...
                data-testid="locations-operational-summary"
            >
                <ConfigWorkspaceCard compact className="h-full min-h-[7.5rem]" testId="locations-readiness">
                    <section>
                ...
                <ConfigWorkspaceCard compact className="h-full min-h-[7.5rem]" testId="locations-attention-summary">
                    <section>
                        <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-alloy-midnight/40">
                            Needs attention
                        </p>
                ...
                <ConfigWorkspaceCard compact className="h-full min-h-[7.5rem]" testId="locations-inventory">
                    <section>
                        <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-alloy-midnight/40">
                            Inventory
                        </p>
            ...
            <div
                ...
                data-testid="locations-main-grid"
            >
                                ...
                                <li key={location.id}>
                                    ...
                                    >
                                        <div className="min-w-0">
                                            ...
                                            {location.locality ?
                                                <p className="config-typo-sublabel mt-0.5">{location.locality}</p>
                                            :   null}
