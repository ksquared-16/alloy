...
export default function LocationProgramDetailPanel({
    ...
    onSave: (
        id: string,
        patch: { label?: string; is_active?: boolean; sort_order?: number; metadata?: Record<string, unknown> },
    ) => Promise<void>;
}) {
    ...
    return (
        <ConfigurationDetailCard testId="locations-program-detail" title={label.trim() || "Untitled program"}>
