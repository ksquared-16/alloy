...
import {
    BUSINESS_PROCESS_AUTOMATION_PLANNED_BODY,
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <p
                    className="mt-2 max-w-md text-sm leading-relaxed text-alloy-midnight/60"
                    data-capability="planned"
                    data-testid="business-process-automation-planned"
                >
                    {BUSINESS_PROCESS_AUTOMATION_PLANNED_BODY}
                </p>
            </div>
