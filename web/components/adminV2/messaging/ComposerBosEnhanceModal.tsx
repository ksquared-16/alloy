...
export default function ComposerBosEnhanceModal({ open, onClose, draft }: ComposerBosEnhanceModalProps) {
    ...
    return (
        ...
        >
            ...
            {!revealComplete ?
                <div
                    className="relative z-10 flex h-[min(24rem,70vh)] w-full max-w-lg items-center justify-center overflow-hidden rounded-[1.35rem] bg-white shadow-2xl"
                ...
                >
                    <BosRevealSequence
                        ...
                        data-testid="composer-bos-enhance-reveal"
                    />
                </div>
            :   <BosWorkspaceShell
                    showHeader={false}
