    ...
    return (
        ...
        >
            ...
            <p className="mt-1 text-[13px] leading-snug">
                This view is configured in <span className="font-medium">Settings → Layouts</span>, but the published
                layout could not be displayed for this record. The legacy view is intentionally not shown.
