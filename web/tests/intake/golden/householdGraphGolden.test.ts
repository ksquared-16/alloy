...
export const GOLDEN_HOUSEHOLD_FIXTURES: GoldenFixtureExpectation[] = [
    ...
    {
        id: "compact-contact-ampersand",
        text: "Sarah & Rudy Emerson 1222344321 sarah@emerson.net\nChildren: Jet DOB 2/4/2026 and Chet 10/10/2023",
        parents: 2,
        children: 2,
        relationships: 4,
        parent_names: ["Sarah Emerson", "Rudy Emerson"],
        child_names: ["Jet", "Chet"],
        warning_codes: ["extra_parents_commit_limited", "extra_children_commit_limited", "child_last_name_inferred"],
    },
    {
        id: "compact-contact-comma",
        text: "Sarah and Rudy Emerson, 1222344321, sarah@emerson.net\nChildren: Jet DOB 2/4/2026 and Chet 10/10/2023",
        parents: 2,
        children: 2,
        relationships: 4,
        parent_names: ["Sarah Emerson", "Rudy Emerson"],
    ...
    {
        id: "compact-children-dot-dates",
        text: "Sarah & Rudy Emerson sarah@emerson.net 1222344321\nKids: Jet DOB 2.4.26 and Chet DOB 10.10.23",
        parents: 2,
        children: 2,
        relationships: 4,
        parent_names: ["Sarah Emerson", "Rudy Emerson"],
    ...
    {
        id: "mixed-surname-compact-contact",
        text: "Sarah Emerson and Rudy Carter 1222344321 sarah@test.com\nChildren: Jet DOB 2/4/2026",
        parents: 2,
        children: 1,
        relationships: 2,
        parent_names: ["Sarah Emerson", "Rudy Carter"],
        child_names: ["Jet"],
        warning_codes: ["extra_parents_commit_limited", "child_last_name_needs_review"],
    },
];
