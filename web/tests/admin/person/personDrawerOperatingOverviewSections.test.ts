...
describe("personDrawerOperatingOverviewSections", () => {
    it("suppresses parent Profile, Contact, Record Info, and Basic by key and title", () => {
        const sections = [
            ...
            { key: "contact_info", title: "Contact", fields: [{ key: "email" }] },
            { key: "record_info", title: "Record Info", fields: [{ key: "created_at" }] },
            { key: "custom_xyz", title: "Basic", fields: [{ key: "notes" }] },
            { key: "preferred_name", title: "Preferred Name", fields: [{ key: "preferred_name" }] },
    ...
    it("suppresses child Child Profile, Basic, Profile, Contact, and Record Info", () => {
        const sections = [
            { key: "child_profile", title: "Child Profile", fields: [{ key: "allergies" }] },
            { key: "basic_info", title: "Basic", fields: [{ key: "first_name" }] },
            { key: "profile", title: "Profile", fields: [{ key: "nickname" }] },
            { key: "contact_info", title: "Contact", fields: [{ key: "email" }] },
            { key: "record_info", title: "Record Info", fields: [{ key: "id" }] },
            { key: "medical", title: "Medical", fields: [{ key: "medical_notes" }] },
        ];
        for (const section of sections.slice(0, 5)) {
