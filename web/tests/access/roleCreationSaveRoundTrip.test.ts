...
const CATALOG: PermissionCatalogEntry[] = [
    { key: "portal.access", label: "Portal access", group_key: "portal", description: null },
    { key: "enrollment.record.manage", label: "Manage Enrollment records", group_key: "enrollment", description: null },
    { key: "enrollment.decide", label: "Make enrollment decisions", group_key: "enrollment", description: null },
    { key: "enrollment.pricing.override", label: "Override recommended tuition", group_key: "enrollment", description: null },
    { key: "enrollment.requirement_exception.manage", label: "Except Enrollment requirements", group_key: "enrollment", description: null },
    { key: "business_process.configure", label: "Configure business processes", group_key: "business_process", description: null },
    { key: "business_process.activate", label: "Activate business processes", group_key: "business_process", description: null },
    { key: "work.configure", label: "Configure work", group_key: "operations", description: null },
    { key: "work.operate", label: "Perform work", group_key: "operations", description: null },
    { key: "tours.configure", label: "Configure tours", group_key: "scheduling", description: null },
    { key: "tours.book", label: "Manage tour bookings", group_key: "scheduling", description: null },
    { key: "admin.users.read", label: "View users", group_key: "system", description: null },
    { key: "admin.users.write", label: "Manage users", group_key: "system", description: null },
    { key: "admin.roles.read", label: "View roles", group_key: "system", description: null },
    { key: "admin.roles.write", label: "Manage roles", group_key: "system", description: null },
    { key: "admin.access_scope.write", label: "Manage user access scope", group_key: "system", description: null },
    { key: "fin.read", label: "View financials", group_key: "financials", description: null },
    { key: "fin.write", label: "Manage financials", group_key: "financials", description: null },
    { key: "fin.post", label: "Post financial transactions", group_key: "financials", description: null },
    { key: "fin.adjust", label: "Adjust an account by hand", group_key: "financials", description: null },
    { key: "fin.responsibility", label: "Configure who is responsible", group_key: "financials", description: null },
    { key: "fin.subsidy", label: "Administer subsidy funding", group_key: "financials", description: null },
];
