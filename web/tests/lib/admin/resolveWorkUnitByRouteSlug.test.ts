...
describe("resolveWorkUnitByRouteSlug", () => {
    ...
    it("prefers enrollment_pipeline over lifecycle_wu_lead when both are present for new-leads slug", () => {
    ...
    it("/workspace/work-unit/active-pipeline resolves to Enrollment parent runtime", () => {
        // active_pipeline is a work-view key in the enrollment pipeline queue definition
        const result = resolveWorkUnitByRouteSlug({
