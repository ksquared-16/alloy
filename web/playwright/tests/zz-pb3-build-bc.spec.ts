...
const SPECIMENS = [
    { tag: "B_two_periods",   first: "Pbtwo",   start: "2026-09-15" },
    { tag: "C_three_periods", first: "Pbthree", start: "2026-09-08" },
];
...
test("build B and C", async ({ page }) => {
    ...
    writeFileSync(`${OUT}/specimens-bc.json`, JSON.stringify(r, null, 2));
});
