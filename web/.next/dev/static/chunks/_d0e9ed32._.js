                ...
                "AdminV2WorkspaceDepartmentPage.useEffect": async ()=>{
                    try {
                        ...
                        for (const row of j.work_units ?? []){
                            ...
                            /** Match work-unit "All" lane — do not sum tabs (overlapping lanes double-count). */ const legacySumAllQueues = {
                                "AdminV2WorkspaceDepartmentPage.useEffect.legacySumAllQueues": ()=>queues.reduce({
                                        "AdminV2WorkspaceDepartmentPage.useEffect.legacySumAllQueues": (acc, q)=>acc + (typeof q.count === "number" ? q.count : 0)
                                    }["AdminV2WorkspaceDepartmentPage.useEffect.legacySumAllQueues"], 0)
                            }["AdminV2WorkspaceDepartmentPage.useEffect.legacySumAllQueues"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminV2WorkspaceDepartmentPage.useEffect": ()=>{
            ...
            const t = window.setTimeout({
                "AdminV2WorkspaceDepartmentPage.useEffect.t": ()=>setDeptSummariesWaitTimedOut(true)
            }["AdminV2WorkspaceDepartmentPage.useEffect.t"], 10_000);
            return ({
                "AdminV2WorkspaceDepartmentPage.useEffect": ()=>clearTimeout(t)
            })["AdminV2WorkspaceDepartmentPage.useEffect"];
        }
    }["AdminV2WorkspaceDepartmentPage.useEffect"], [
...
//# sourceMappingURL=_d0e9ed32._.js.map