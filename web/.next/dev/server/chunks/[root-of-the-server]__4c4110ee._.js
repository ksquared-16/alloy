...
"[project]/app/api/admin/work-units/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, context) {
    ...
    const { data: row, error } = await supabase.from("work_units").select("id, org_id, department_id, key, name, description, sort_order, is_active, queue_definition, metadata, created_at, updated_at").eq("id", id).eq("org_id", ctx.orgId).maybeSingle();
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
...
async function PATCH(request, context) {
    ...
    if (touchesQueue) {
        if (!("queue_definition" in body) || !("expected_queue_definition_version" in body)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "queue_definition and expected_queue_definition_version are required together when updating queue_definition"
            }, {
                status: 400
            });
        }
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data: existing, error: fetchErr } = await supabase.from("work_units").select("id, department_id, queue_definition").eq("id", id).eq("org_id", ctx.orgId).maybeSingle();
    ...
    if (body.department_id !== undefined) {
        ...
        if (!newDeptId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "department_id cannot be empty"
            }, {
                status: 400
            });
        }
        const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$assertRowOrg$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertRowOrg"])(supabase, "departments", newDeptId, ctx.orgId);
        if (!ok.ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (touchesQueue) {
        ...
        const currentIsEmpty = currentQd == null || typeof currentQd === "object" && !Array.isArray(currentQd) && Object.keys(currentQd).length === 0;
        if (!currentIsEmpty) {
            const currentVersion = typeof currentQd === "object" && currentQd != null && !Array.isArray(currentQd) ? currentQd.version : undefined;
            if (currentVersion !== 1) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            const validated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$queueDefinitionSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateQueueDefinition"])(qdRaw);
            updates.queue_definition = validated;
        } catch (e) {
    ...
    const { data: updated, error: updateErr } = await supabase.from("work_units").update(updates).eq("id", id).eq("org_id", ctx.orgId).select().single();
    if (updateErr) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c4110ee._.js.map