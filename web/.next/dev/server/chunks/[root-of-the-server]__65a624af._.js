...
"[project]/app/api/admin/record-actions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const { data, error } = await supabase.from("record_actions").select("id, entity_type, action_key, label, event_key, placement, is_active, created_at").eq("entity_type", entityType).eq("is_active", true).order("placement", {
        ascending: true
    }).order("created_at", {
        ascending: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65a624af._.js.map