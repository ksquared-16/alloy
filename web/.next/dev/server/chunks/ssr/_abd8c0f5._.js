...
async function loadWorkspaceRollup(departments) {
    ...
    const orgOpportunityKpis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$workspace$2f$viewModels$2f$workspaceRootRollup$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildWorkspaceRootOrgOpportunityKpis"])(growthSnapshots.map((s)=>({
            departmentKey: s.key,
            kpis: s.payload
        })));
    const metrics = {
