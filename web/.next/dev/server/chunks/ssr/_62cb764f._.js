...
function buildEnrollmentCrmRowSemanticSlots(row, options) {
    ...
    const desiredStart = row._desired_start_date?.trim() || null;
    const ageContext = desiredStart || row._age_band?.trim() || null;
    const tourCtx = row._tour_context?.trim() || row._tour_timing?.trim() || null;
    const attentionReason = row._attention_reason_label?.trim() || null;
    const familyNote = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$opportunityActivityTimelineFormat$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formatOpportunityQueueNotesPreview"])(row._notes_preview);
...
//# sourceMappingURL=_62cb764f._.js.map