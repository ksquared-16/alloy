...
"[project]/app/api/admin/location-options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: rows, error } = await supabase.from("locations").select("id, label, address1, city, state, postal_code").eq("org_id", ctx.orgId).eq("is_active", true).order("label", {
        ascending: true,
        nullsFirst: false
    });
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5306876f._.js.map