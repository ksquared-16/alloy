...
"[project]/app/api/admin/departments/[departmentId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, context) {
    ...
    const { data: row, error } = await supabase.from("departments").select("id, org_id, key, name, description, sort_order, is_active, metadata, created_at, updated_at").eq("id", departmentId).eq("org_id", ctx.orgId).maybeSingle();
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
...
async function PATCH(request, context) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data: existing, error: fetchErr } = await supabase.from("departments").select("id").eq("id", departmentId).eq("org_id", ctx.orgId).maybeSingle();
    ...
    const { data: updated, error: updateErr } = await supabase.from("departments").update(updates).eq("id", departmentId).eq("org_id", ctx.orgId).select().single();
    if (updateErr) {
        const code = updateErr.code;
        if (code === "23505") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "A department with this key already exists"
            }, {
                status: 409
            });
        }
...
async function DELETE(_request, context) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { count } = await supabase.from("work_units").select("id", {
        count: "exact",
        head: true
    }).eq("department_id", departmentId).eq("org_id", ctx.orgId);
    if ((count ?? 0) > 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ff9908e._.js.map