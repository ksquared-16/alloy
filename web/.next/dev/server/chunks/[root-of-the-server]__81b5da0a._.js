...
"[project]/app/api/admin/customer-options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: rows, error } = await supabase.from("customers").select("id, name, status_key, customer_number").eq("org_id", ctx.orgId).order("name", {
        ascending: true,
        nullsFirst: false
    });
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81b5da0a._.js.map