...
"[project]/app/api/admin/verticals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        ...
        const { data, error } = await supabase.from("verticals").select("id, name, slug").order("name", {
            ascending: true
        });
...
async function POST(request) {
    const forbidden = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__017215de._.js.map