...
"[project]/app/api/admin/work-units/[id]/queues/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseSummaryMode(searchParams) {
    ...
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queues$2f$QueueService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueueServiceError"]("summary_mode must be all, initial, priority, or partial", 400, "VALIDATION_FAILED");
}
function parseOnlyQueueKeys(searchParams) {
...
async function GET(request, context) {
    ...
    try {
        ...
        if (priorityBudgetRaw) {
            ...
            if (!Number.isFinite(n)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queues$2f$QueueService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueueServiceError"]("priority_budget must be a number", 400, "VALIDATION_FAILED");
            priorityBudget = Math.min(Math.max(1, Math.floor(n)), 20);
        }
        if (summaryModeParsed === "partial" && (!onlyQueueKeys || onlyQueueKeys.size === 0)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queues$2f$QueueService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueueServiceError"]("only_queue_keys is required when summary_mode=partial", 400, "VALIDATION_FAILED");
        }
        const effectiveSummaryMode = onlyQueueKeys && onlyQueueKeys.size > 0 ? "partial" : summaryModeParsed === "priority" ? "priority" : "all";
        const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queues$2f$QueueService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkUnitQueueSummaries"])({
            orgId: ctx.orgId,
            workUnitId: id,
            limit,
            includePreviews,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3abb324e._.js.map