...
"[project]/app/api/admin/status-options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const defs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$statusDefinitionsResolve$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fetchEffectiveStatusDefinitions"])(supabase, ctx.orgId, entityType, {
            activeOnly: true
        });
        const options = defs.map((r)=>({
                ...
                lifecycle_stage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2f$statusDefinitionLifecycle$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseLifecycleStageFromMetadata"])(r.metadata)
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            options
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7adff7e2._.js.map