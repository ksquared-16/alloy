...
"[project]/app/api/admin/departments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: rows, error } = await supabase.from("departments").select("id, org_id, key, name, description, sort_order, is_active, metadata, created_at, updated_at").eq("org_id", ctx.orgId).order("sort_order", {
        ascending: true
    }).order("name", {
        ascending: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f87f0a9._.js.map