 ...
 * Default: refuses without confirmation env. Use SQL script for true single-transaction delete.
 *
 * Env:
 ...
 *
 * For rollback-safe single transaction, prefer:
 *   supabase/scripts/demo_runtime_cleanup_execute.sql
 *
...
async function executeDeletes(
    ...
    deleted.locations = await deleteByOr(supabase, "locations", orgId, orDemo);
