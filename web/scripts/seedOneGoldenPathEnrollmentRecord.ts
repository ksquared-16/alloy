 ...
 *
 * Delete this family only:
 *   DEMO_SEED_RUN_ID=<run_id> npm run demo:delete:one-family -- --run-id=<run_id> --execute
 *
...
async function main(): Promise<void> {
    ...
    const output = {
        ...
        cleanup: {
            dry_run: `DEMO_SEED_RUN_ID=${runId} DEMO_RESET_ORG_ID=${orgId} npm run demo:cleanup:dry`,
            delete_family: `DEMO_RESET_ORG_ID=${orgId} npm run demo:delete:one-family -- --run-id=${runId} --execute`,
        },
    };
