  ...
  return (
    <div className={`${cardClass} flex flex-col items-stretch`} aria-hidden>
      <div className="adminv2-ws-wu-queue-card-compact-text">
        ...
        <div className="mt-2 h-3 w-56 skeleton-pulse rounded bg-alloy-stone/12" style={{ animationDelay: "70ms" }} />
        <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-1 text-[11px] tabular-nums" style={{ color: "var(--d-muted)" }}>
          <div>
            ...
            <span className="inline-block h-3 w-10 align-middle skeleton-pulse rounded bg-alloy-stone/12" style={{ animationDelay: "120ms" }} />
          </div>
          <div className="text-right">
            <span className="font-medium text-alloy-midnight/75">Value</span>{" "}
            <span className="inline-block h-3 w-14 align-middle skeleton-pulse rounded bg-alloy-stone/12" style={{ animationDelay: "160ms" }} />
          </div>
        </div>
      </div>
      <div className="adminv2-ws-wu-queue-card-compact-aside">
        <span className="adminv2-ws-wu-queue-action-chip adminv2-ws-wu-queue-action-chip--open">
          <span className="inline-block h-3 w-16 align-middle skeleton-pulse rounded bg-alloy-stone/10" style={{ animationDelay: "90ms" }} />
        </span>
      </div>
    </div>
  );
...
export default function Loading() {
  return (
    <div className="w-full max-w-none mx-0 px-0 pt-2 pb-0 space-y-4">
        ...
        <div className="adminv2-ws-dept-v2-contain">
          <div className="adminv2-ws-dept-v2-page-split">
            <div className="adminv2-ws-dept-v2-primary-column">
                ...
                <div className="adminv2-ws-dept-v2-top-stack">
                  <div className="adminv2-ws-dept-v2-brief">
                    ...
                    <div className="mt-3 space-y-2 max-w-3xl" aria-hidden>
                      ...
                      <div className="h-3 w-2/3 skeleton-pulse rounded bg-alloy-stone/10" style={{ animationDelay: "70ms" }} />
                    </div>
                  </div>
              ...
              <div className="adminv2-ws-dept-v2-operational-row adminv2-ws-dept-v2-operational-row--triple" aria-label="Operational lanes">
                <div className="adminv2-ws-dept-v2-lane adminv2-ws-dept-v2-lane--throughput" data-ws-lane-kind="throughput">
                  <div className="adminv2-ws-dept-v2-lane-chrome adminv2-ws-dept-v2-lane-chrome--throughput-deck">
                    <section className="adminv2-ws-dept-qsec adminv2-ws-dept-qsec--primary adminv2-ws-dept-throughput-panel" aria-label="Pipeline lanes">
                      ...
                      <header className="adminv2-ws-attention-panel-header">
                        <div>
                          ...
                          <div className="mt-2 space-y-2" aria-hidden>
                            ...
                            <div className="h-3 w-56 skeleton-pulse rounded bg-alloy-stone/10" style={{ animationDelay: "90ms" }} />
                          </div>
                        </div>
                      </header>
