    ...
    return (
        <div className="w-full max-w-6xl space-y-6">
            ...
            <p className="text-xs leading-relaxed text-alloy-midnight/50">
                Rows are org-scoped in <code className="rounded bg-alloy-stone/35 px-1 text-[11px]">field_definitions</code>.
                Registry seeds run at deploy time; an empty list until backfill is expected for new orgs.
            </p>
