    ...
    return (
        <WorkspaceChrome
            breadcrumbs={[
                ...
                { href: `/admin/workspace/dept/${departmentId}`, label: deptName },
                { href: `/admin/workspace/dept/${departmentId}/unassigned`, label: "Unassigned jobs" },
            ]}
            title="Unassigned jobs"
            subtitle="Jobs are loaded from the existing admin jobs API (unassigned_work_unit=true). Row actions open the entity drawer with resolver surface=drawer; use RRS overview in the drawer for surface=overview; full page uses the existing job record route."
        >
