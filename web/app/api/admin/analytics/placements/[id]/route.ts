...
import { validateMetricPlacementUpdate } from "@/lib/metrics/platform/metricPlacementSchema";
...
export async function PATCH(request: NextRequest, context: RouteContext) {
    /*
     * ANALYTICS TRUTH — edits a metric placement.
     *
    ...
    try {
        const input = validateMetricPlacementUpdate(body);
