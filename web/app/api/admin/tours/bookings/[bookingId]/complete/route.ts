...
import { markTourBookingCompleted } from "@/lib/tours/bookings/tourBookingService";
import { getAdminAccessContextCached } from "@/lib/admin/getAdminAccessContext";
import { TOURS_BOOK, requireToursCapability } from "@/lib/access/toursAuthority";

/** POST /api/admin/tours/bookings/[bookingId]/complete */
export async function POST(_request: NextRequest, { params }: { params: Promise<{ bookingId: string }> }) {
    /*
     * TOURS BOOKING — records one family's tour as completed.
     *
