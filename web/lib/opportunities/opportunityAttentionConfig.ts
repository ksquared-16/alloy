...
function defaultPolicies(): Record<OpportunityAttentionReasonCode, OpportunityAttentionReasonPolicy> {
    const defaults: Record<OpportunityAttentionReasonCode, OpportunityAttentionReasonPolicy> = {
        ...
        stage_work_overdue: { enabled: true, severity: DEFAULT_SEVERITY_BY_REASON.stage_work_overdue },
        stage_age_exceeded: { enabled: true, severity: DEFAULT_SEVERITY_BY_REASON.stage_age_exceeded },
        stage_missing_required_fields: {
            enabled: true,
            severity: DEFAULT_SEVERITY_BY_REASON.stage_missing_required_fields,
        },
        stage_attempts_incomplete: {
            enabled: true,
            severity: DEFAULT_SEVERITY_BY_REASON.stage_attempts_incomplete,
        },
...
function defaultLabels(): Record<OpportunityAttentionReasonCode, string> {
    return {
        ...
        stage_work_overdue: "Stage work overdue",
        stage_age_exceeded: "Stage age exceeded",
        stage_missing_required_fields: "Stage required fields missing",
        stage_attempts_incomplete: "Stage attempts incomplete",
