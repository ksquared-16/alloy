...
export type OpenRosterModalDetail = {
    /**
     * Roster is the expectation mode and Attendance the actuality mode; Staff and Children are the
     * durable population underneath both. All four are sections of one workspace, so a deep link
     * written to the old separate Records workspace names `staff`/`children` here and still lands.
     */
