...
export const OPERATIONAL_FORM_SYSTEM_FIELDS: readonly SystemFieldRegistryEntry[] = [
    ...
    },
    {
        ...
        default_label: "Child site",
        default_description: "Preferred center/site for this child (maps to inquiry child site).",
        default_required: false,
        suggested_kind: "select",
        public_intake_safe: true,
    },
    ...
    },
    {
        ...
        shared_value_key: "desired_program_type",
        crm_mapping_key: "enrollment.desired_program_type",
    ...
    },
    {
        ...
        shared_value_key: "desired_schedule_type",
        crm_mapping_key: "enrollment.desired_schedule_type",
