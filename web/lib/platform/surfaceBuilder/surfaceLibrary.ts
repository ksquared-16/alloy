...
export const SURFACE_LIBRARY: readonly SurfaceLibraryEntry[] = [
    ...
    },
    {
        ...
        subtitle: "Opportunity pipeline work-unit row — household, status, attention, dates",
        category: "Operator surfaces",
        status: "published",
        appearsIn: ["Work unit queue", "Pipeline view"],
        editor: "queue-row-builder",
    },
    {
        id: "waitlist-queue-row",
        title: "Waitlist Queue Row",
        subtitle: "Placement candidate waitlist row — rank, tier, placement override, sibling context",
        category: "Operator surfaces",
        status: "published",
        appearsIn: ["Waitlist queue", "Placement priority view"],
        editor: "queue-row-builder",
    },
    {
