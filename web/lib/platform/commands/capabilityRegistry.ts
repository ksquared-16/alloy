...
export const REGISTERED_ACTION_CAPABILITY_KEYS = [
    ...
    "attendance.plan_absence",
    "attendance.revise_absence",
...
const CAPABILITY_DEFINITIONS: readonly PlatformCapabilityDefinition[] = [
    ...
    def({
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.check_in",
        implementationStatus: "production",
        reason: "Appends one immutable attendance fact. An active enrolment covering the service date is required.",
    }),
    def({
        capabilityKey: "attendance.check_out",
        canonicalCommandKey: "attendance.check_out",
        operatorLabel: "Check out",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.check_out",
        implementationStatus: "production",
        reason: "Appends one immutable attendance fact closing the day's presence.",
    }),
    def({
        capabilityKey: "attendance.move",
        canonicalCommandKey: "attendance.move",
        operatorLabel: "Move room",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.move",
        implementationStatus: "production",
        reason:
            "Appends ONE room_transfer fact. Never check-out plus check-in, which would fabricate a departure and split the day into two presences.",
    }),
    def({
        capabilityKey: "attendance.correct",
        canonicalCommandKey: "attendance.correct",
        operatorLabel: "Correct attendance",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "confirm",
        registeredActionKey: "attendance.correct",
        implementationStatus: "production",
        reason:
            "Appends a correction/reversal referencing the original event. Nothing is edited in place, so the audit lineage survives.",
    }),
    def({
        capabilityKey: "attendance.mark_absent",
        canonicalCommandKey: "attendance.mark_absent",
        operatorLabel: "Mark absent",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.mark_absent",
        implementationStatus: "production",
        reason:
            "Appends one immutable absence fact for the service date. Superseded for operator use by attendance.plan_absence, which states what is EXPECTED rather than witnessing what was observed; kept for existing callers and historical data.",
    }),
    def({
        capabilityKey: "attendance.plan_absence",
        canonicalCommandKey: "attendance.plan_absence",
        operatorLabel: "Mark absent",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.plan_absence",
        implementationStatus: "production",
        reason:
            "States that a child is not expected in, today or on future days. Authors operational intent rather than a witnessed fact, so the schedule stays true and a child who arrives anyway is still recorded as present.",
    }),
    def({
        capabilityKey: "attendance.revise_absence",
        canonicalCommandKey: "attendance.revise_absence",
        operatorLabel: "Change these dates",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.revise_absence",
        implementationStatus: "production",
        reason:
            "Changes the days or reason a child is away. The earlier plan is superseded by reference, never edited, so the history of what was expected survives.",
    }),
    def({
        capabilityKey: "attendance.withdraw_absence",
        canonicalCommandKey: "attendance.withdraw_absence",
        operatorLabel: "They'll be in after all",
        family: "scheduling",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "attendance.withdraw_absence",
        implementationStatus: "production",
        reason:
            "Puts a child back on the expected roster after a planned absence. Recorded as a change of plan, so the child is missed again if they do not arrive.",
    }),
    def({
    ...
    def({
        ...
        canonicalCommandKey: "staff.add",
        operatorLabel: "Add staff",
        family: "record_creation",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
    ...
    def({
        capabilityKey: "enrollment.start",
        canonicalCommandKey: "enrollment.start",
        operatorLabel: "Start enrollment",
        family: "enrollment",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "confirm",
        registeredActionKey: "enrollment.start",
        implementationStatus: "production",
        reason:
    ...
    def({
        ...
        canonicalCommandKey: "enrollment.direct",
        operatorLabel: "Enroll directly",
        family: "enrollment",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "confirm",
        registeredActionKey: "enrollment.direct",
        implementationStatus: "production",
        reason:
            "Enrollment Context Convergence. Bypasses the acquisition journey, never the durable facts: delegates to the one materialization core and refuses when the result would be a child no roster can see. Writes no process_instance — a journey nobody ran is not recorded as one.",
    }),
    def({
        capabilityKey: "employment.update",
        canonicalCommandKey: "employment.update",
        operatorLabel: "Edit employment",
        ...
        supportsPreview: true,
        confirmationPolicy: "none",
        registeredActionKey: "employment.update",
        implementationStatus: "production",
        reason: "Staff Foundation. Amends open employment only; ended employment is history.",
    }),
    def({
        capabilityKey: "employment.end",
        canonicalCommandKey: "employment.end",
        operatorLabel: "End employment",
        family: "relationships",
        maturity: "executable",
        executionOwner: "registered_action",
        catalogVisibility: "organization_command_catalog",
        ...
        supportsPreview: true,
        confirmationPolicy: "confirm",
        registeredActionKey: "employment.end",
        implementationStatus: "production",
        reason: "Staff Foundation. Closes the employment window; history preserved, nothing deleted.",
    }),
    def({
