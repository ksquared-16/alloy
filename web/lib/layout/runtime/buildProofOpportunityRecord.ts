...
export function buildProofOpportunityRecord(overrides: Partial<ProofRuntimeRecord> = {}): ProofRuntimeRecord {
    const base: ProofRuntimeRecord = {
        ...
        enrollment_children: [
            {
                id: "enroll-child-1",
                "child_inquiry.child_name": "Alex Johnson",
                "child_inquiry.desired_start_date": "2026-09-01",
                "child_inquiry.location_id": "Sunshine — Main Campus",
                "child_inquiry.program_room_cohort_key": "Infant AM",
                "child_inquiry.outcome_status_key": "Active inquiry",
            },
            {
                id: "enroll-child-2",
                "child_inquiry.child_name": "Sam Johnson",
                "child_inquiry.desired_start_date": "2027-01-15",
                "child_inquiry.location_id": "Sunshine — Main Campus",
                "child_inquiry.program_room_cohort_key": "Toddler PM",
                "child_inquiry.outcome_status_key": "Waitlisted",
            },
        ],
