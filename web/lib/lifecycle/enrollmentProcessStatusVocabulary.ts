...
export const ENROLLMENT_FAMILY_TRACK_STATUS_VOCABULARY: EnrollmentStatusVocabularyRow[] = [
    ...
    { status_key: "tour_requested", status_label: "Tour Requested", sort_order: 20, stage_key: "tour", entity_type: "opportunities", track_key: ENROLLMENT_TRACK_FAMILY_KEY },
    { status_key: "tour_scheduled", status_label: "Tour Scheduled", sort_order: 25, stage_key: "tour", entity_type: "opportunities", track_key: ENROLLMENT_TRACK_FAMILY_KEY },
    { status_key: "tour_completed", status_label: "Tour Completed", sort_order: 30, stage_key: "tour", entity_type: "opportunities", track_key: ENROLLMENT_TRACK_FAMILY_KEY },
    { status_key: "decision_pending", status_label: "Decision Pending", sort_order: 35, stage_key: "decision", entity_type: "opportunities", track_key: ENROLLMENT_TRACK_FAMILY_KEY },
