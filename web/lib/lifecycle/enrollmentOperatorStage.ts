...
export function parseEnrollmentOperatorStageFromMetadata(
...
): LifecycleOperatorStage | typeof ENROLLMENT_OPERATOR_STAGE_UNASSIGNED | null {
    ...
    return isLifecycleOperatorStage(t) ? t : null;
}
...
export function mergeEnrollmentOperatorStageMetadata(
    ...
    stage: LifecycleOperatorStage | typeof ENROLLMENT_OPERATOR_STAGE_UNASSIGNED | null
