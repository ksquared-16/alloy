...
> = {
    ...
    // NOT `contact_family`: the family's Lead-stage Contact Family work binds there too, so sharing
    // the definition let the stage-move reconciler carry that work forward as though it already
    // satisfied Waitlist entry — and the review was never created.
    review_waitlist_position: "review_waitlist_position",
