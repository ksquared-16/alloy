...
export const FINANCIALS_CURRENT: FinancialsEvidence = {
    ...
    pastDue: null,
    ledger: [
        { when: "Aug 20, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment received", amount: "−$1,665", kind: "credit", status: "Settled", source: "Autopay · Visa 4242" , glCode: "1010 · Cash" , subject: "Household" },
        { when: "Aug 12, 2026", type: "discount", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Sibling discount", amount: "−$185", kind: "credit", status: "Posted", source: "Rate rule" , glCode: "4900 · Discounts" , subject: "Household" },
        { when: "Aug 01, 2026", type: "service", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Tuition — August", amount: "+$1,850", kind: "charge", status: "Paid", source: "Schedule" , glCode: "4000 · Tuition revenue" , subject: "Avery" },
        { when: "Jul 20, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment received", amount: "−$1,665", kind: "credit", status: "Settled", source: "Autopay · Visa 4242" , glCode: "1010 · Cash" , subject: "Household" },
        { when: "Jul 01, 2026", type: "service", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Tuition — July", amount: "+$1,850", kind: "charge", status: "Paid", source: "Schedule" , glCode: "4000 · Tuition revenue" , subject: "Avery" },
    ],
    payers: [
...
export const FINANCIALS_PAST_DUE: FinancialsEvidence = {
    ...
    ledger: [
        { when: "Aug 20, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment received", amount: "−$925", kind: "credit", status: "Settled", source: "Operator · ACH 8813" , glCode: "1010 · Cash" , subject: "Household" },
        { when: "Aug 16, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment attempt", amount: "$0", kind: "charge", status: "Declined", source: "Autopay · Visa 4242" , glCode: "1010 · Cash" , subject: "Household" },
        { when: "Aug 15, 2026", type: "subsidy_offset", lens: "funding", responsibleParty: null, responsibilityUnassigned: false, label: "State subsidy", amount: "−$600", kind: "credit", status: "Posted", source: "Child Care Assistance" , glCode: "4200 · Subsidy revenue" , subject: "Riley" },
        { when: "Aug 12, 2026", type: "discount", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Sibling discount", amount: "−$185", kind: "credit", status: "Posted", source: "Rate rule" , glCode: "4900 · Discounts" , subject: "Household" },
        { when: "Aug 01, 2026", type: "fee", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Field trip", amount: "+$40", kind: "charge", status: "Unpaid", source: "Manual · operator" , glCode: "4100 · Fee revenue" , subject: "Avery" },
        { when: "Aug 01, 2026", type: "fee", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Registration fee", amount: "+$75", kind: "charge", status: "Partially paid", source: "Enrollment" , glCode: "4100 · Fee revenue" , subject: "Avery" },
        { when: "Aug 01, 2026", type: "service", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Tuition — August", amount: "+$1,850", kind: "charge", status: "Partially paid", source: "Schedule" , glCode: "4000 · Tuition revenue" , subject: "Avery" },
    ],
    payers: [
...
export const FINANCIALS_MIXED_FUNDING: FinancialsEvidence = {
    ...
    pastDue: null,
    ledger: [
        { when: "Aug 20, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment received", amount: "−$925", kind: "credit", status: "Settled", source: "Autopay · Visa 4242" , glCode: "1010 · Cash" , subject: "Household" },
        { when: "Aug 15, 2026", type: "subsidy_offset", lens: "funding", responsibleParty: null, responsibilityUnassigned: false, label: "State subsidy", amount: "−$600", kind: "credit", status: "Posted", source: "Child Care Assistance" , glCode: "4200 · Subsidy revenue" , subject: "Riley" },
        { when: "Aug 12, 2026", type: "discount", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Sibling discount", amount: "−$185", kind: "credit", status: "Posted", source: "Rate rule" , glCode: "4900 · Discounts" , subject: "Household" },
        { when: "Aug 08, 2026", type: "credit", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Vacation credit", amount: "−$100", kind: "credit", status: "Posted", source: "Operator" , glCode: "4900 · Discounts" , subject: "Household" },
        { when: "Aug 01, 2026", type: "service", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Tuition — August", amount: "+$1,850", kind: "charge", status: "Partially paid", source: "Schedule" , glCode: "4000 · Tuition revenue" , subject: "Avery" },
    ],
    payers: [
...
export const FINANCIALS_LEDGER_PERIODS: FinancialsLedgerPeriod[] = [
    { label: "August 2026", summary: "Balance $255", open: true, entries: FINANCIALS_PAST_DUE.ledger },
    {
        ...
        entries: [
            { when: "Jul 20, 2026", type: "payment", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Payment received", amount: "−$1,665", kind: "credit", status: "Settled", source: "Autopay · Visa 4242" , glCode: "1010 · Cash" , subject: "Household" },
            { when: "Jul 01, 2026", type: "service", lens: "charges", responsibleParty: null, responsibilityUnassigned: false, label: "Tuition — July", amount: "+$1,850", kind: "charge", status: "Paid", source: "Schedule" , glCode: "4000 · Tuition revenue" , subject: "Avery" },
            { when: "Jul 01, 2026", type: "discount", lens: "credits", responsibleParty: null, responsibilityUnassigned: false, label: "Sibling discount", amount: "−$185", kind: "credit", status: "Posted", source: "Rate rule" , glCode: "4900 · Discounts" , subject: "Household" },
        ],
    },
