...
/** Home Services org — company-level operating overview (departments as work objects) */
export const demoHomeServicesCompanyModelBase: Omit<CompanyWorkspaceModel, "workspaceLevel" | "contextRail"> = {
...
export const demoHomeServicesCompanyContextRaw: ContextRelationshipRawData = {
  regions: [
...
/** @deprecated use demoHomeServicesCompanyModelBase */
export const demoCleaningCompanyModelBase = demoHomeServicesCompanyModelBase;
/** @deprecated use demoHomeServicesCompanyContextRaw */
export const demoCleaningCompanyContextRaw = demoHomeServicesCompanyContextRaw;
