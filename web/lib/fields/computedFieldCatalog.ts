...
const COMPUTED_FIELDS: ComputedFieldDefinition[] = [
    ...
    {
        refKey: "person.full_name",
        label: "Full name",
        entity_type: "person",
        settings_entity: "person",
        section_key: "identity",
        description: "Display name composed from first and last name (or stored full_name).",
        field_type: "text",
        ownership: "computed",
        source_derivation: "persons.first_name + persons.last_name (or persons.full_name)",
        resolver_ref_keys: ["person.full_name", "contact.full_name"],
        resolver_owner: "web/lib/adminV2/runtime/focusPanel/identity/identitySurfaceCompose.ts",
        resolver_status: "now",
        intended_surfaces: ["drawer", "queue_row", "focus_panel"],
        editable: false,
        configurable: false,
        dependencies: ["person.first_name", "person.last_name"],
        example: "Jordan Lee",
        fallback_behavior: "Empty when no name parts are present.",
    },
    {
        ...
        field_type: "text",
        ownership: "computed",
        source_derivation: "customer_members preferred/first/last name composition",
        resolver_ref_keys: ["child.full_name", "child.display_name"],
        resolver_owner: "web/lib/adminV2/runtime/focusPanel/identity/identitySurfaceCompose.ts",
        resolver_status: "now",
        intended_surfaces: ["drawer", "queue_row", "focus_panel"],
        editable: false,
        configurable: false,
        dependencies: ["child.first_name", "child.last_name", "child.preferred_name"],
        example: "Sam Rivera",
        fallback_behavior: "Empty when no name parts are present.",
    },
    {
    ...
    },
    {
        ...
        settings_entity: "opportunity",
        section_key: "runtime_signals",
        description: "How long the subject has been in its current operational stage (compact relative duration).",
        field_type: "text",
        ownership: "computed",
        source_derivation: "stage_entered_at vs now via resolveOperationalStateEnteredAt",
        resolver_ref_keys: ["opportunity.days_in_stage", "queue_row.operational_age"],
        resolver_owner: "web/lib/lifecycle/operationalStateEnteredAt.ts",
        resolver_status: "now",
        intended_surfaces: ["queue_row", "focus_panel", "drawer"],
        editable: false,
        configurable: false,
