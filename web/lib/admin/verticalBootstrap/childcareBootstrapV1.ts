...
export const CHILDCARE_VERTICAL_BOOTSTRAP_V1: VerticalBootstrapPayloadV1 = {
    ...
    // Collapsed durable-status vocabulary (Enrollment Alignment). Status is durable truth only:
    // stage position (New Lead / Tour / Decision / Waitlist / Enrolling / …) lives in the Business
    // Process (stage_key), and operational progress lives in Work — NOT in status. Keep this in sync
    // with web/lib/lifecycle/enrollmentProcessStatusVocabulary.ts.
    status_definitions: [
        {
            ...
            sort_order: 10,
            is_active: true,
            metadata: { alloy_layer: "enrollment_process", process_key: "enrollment_process", entity_scope: "family_case" },
        },
        {
            entity_type: "opportunities",
            status_key: "closed",
            ...
            sort_order: 20,
            is_active: true,
            metadata: { alloy_layer: "enrollment_process", process_key: "enrollment_process", entity_scope: "family_case", terminal: true },
        },
        {
            ...
            sort_order: 10,
            is_active: true,
            metadata: { alloy_layer: "enrollment_disposition", process_key: "enrollment_process", entity_scope: "enrollment_track" },
        },
        {
            entity_type: "opportunity_customer_members",
        ...
        },
        {
            ...
            sort_order: 40,
            is_active: true,
            metadata: { alloy_layer: "enrollment_disposition", process_key: "enrollment_process", entity_scope: "enrollment_track", terminal: true },
        },
        {
            entity_type: "opportunity_customer_members",
