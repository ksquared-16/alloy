...
const ENTITY_PRESENTATION_REGISTRY: Record<EntityPresentationType, EntityPresentationConfig> = {
      ...
      overviewSections: [
        {
          ...
          fields: [
            ...
            { key: "_access_method_label", label: "Access method", span: 1, renderHint: "text", locked: true },
            { key: "access_code", label: "Code", span: 1, renderHint: "text", editable: true },
            { key: "has_pets", label: "Pets on site", span: 1, renderHint: "primary_yes_no", editable: true },
            { key: "_service_home_type_label", label: "Home type", span: 1, renderHint: "text", locked: true },
            { key: "_service_square_footage_display", label: "Square footage", span: 1, renderHint: "text", locked: true },
            { key: "_service_bedrooms", label: "Bedrooms", span: 1, renderHint: "text", locked: true },
            { key: "_service_bathrooms", label: "Bathrooms", span: 1, renderHint: "text", locked: true },
  ...
  jobs: {
    ...
    table: {
      columns: [
        ...
        { key: "_work_unit_label", label: "Work unit", sortable: false, renderHint: "text" },
      ...
      overviewSections: [
        {
          ...
          fields: [
            ...
            { key: "_customer_name", label: "Customer", span: 1, renderHint: "text" },
  ...
  payments: {
    ...
    table: {
      columns: [
        { key: "status", label: "Status", sortable: true, renderHint: "text", locked: true },
        ...
        { key: "processor", label: "Processor", sortable: false, renderHint: "text" },
        { key: "processor_transaction_id", label: "Txn / ref", sortable: false, renderHint: "text" },
        { key: "allocated_amount_cents", label: "Allocated", sortable: true, renderHint: "money" },
        { key: "unallocated_amount_cents", label: "Unallocated", sortable: true, renderHint: "money" },
        { key: "allocation_state", label: "Alloc.", sortable: false, renderHint: "text" },
        { key: "received_at", label: "Received", sortable: true, renderHint: "datetime" },
        { key: "posted_at", label: "Posted", sortable: true, renderHint: "datetime" },
        { key: "_updated", label: "Updated", sortable: true, renderHint: "datetime", locked: true },
      ],
      defaultSort: { key: "_updated", direction: "desc" },
    },
      ...
      overviewSections: [
        {
          ...
          gridCols: 2,
          fields: [
            { key: "status", label: "Status (canonical)", span: 1, renderHint: "text", locked: true },
            { key: "status_key", label: "Status key (config)", span: 1, renderHint: "status", editable: true },
            { key: "_payment_label", label: "Payment label", span: 1, renderHint: "text" },
            { key: "amount_cents", label: "Amount", span: 1, renderHint: "money" },
            { key: "currency", label: "Currency", span: 1, renderHint: "text" },
            { key: "processor", label: "Processor", span: 1, renderHint: "text" },
            { key: "processor_transaction_id", label: "Processor transaction id", span: 1, renderHint: "text" },
            { key: "provider_payment_id", label: "Provider ref (legacy)", span: 1, renderHint: "text" },
            { key: "received_at", label: "Received at", span: 1, renderHint: "datetime" },
            { key: "posted_at", label: "Posted at", span: 1, renderHint: "datetime" },
            { key: "paid_at", label: "Paid at (legacy)", span: 1, renderHint: "datetime", editable: true },
