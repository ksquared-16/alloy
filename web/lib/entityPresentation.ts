      ...
      overviewSections: [
        {
          ...
          fields: [
            ...
            { key: "_service_home_type_label", label: "Home type", span: 1, renderHint: "text" },
            { key: "_service_square_footage_display", label: "Square footage", span: 1, renderHint: "text" },
            { key: "_service_bedrooms", label: "Bedrooms", span: 1, renderHint: "text" },
            { key: "_service_bathrooms", label: "Bathrooms", span: 1, renderHint: "text" },
            { key: "updated_at", label: "Updated", span: 1, renderHint: "datetime" },
          ],
          locked: true,
        },
