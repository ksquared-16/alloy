...
product_certify_cmd_env() {
  env \
    ...
    ALLOY_METADATA_DIR="${PRODUCT_CERT_ROOT}/runtime/metadata" \
    ALLOY_PIDS_DIR="${PRODUCT_CERT_ROOT}/runtime/pids" \
    ALLOY_LOGS_DIR="${PRODUCT_CERT_ROOT}/runtime/logs" \
    ALLOY_LOCKS_DIR="${PRODUCT_CERT_ROOT}/runtime/locks" \
    ...
    ALLOY_FIRST_AGENT_PORT="${PRODUCT_CERT_FIRST_PORT:-3911}" \
