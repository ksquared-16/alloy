...
CERT_DIR="$ROOT/certification/enrollment-process-instance-anchor"
CONTAINER="alloy-cert-enrollment-process-instance-anchor"
PORT="${ENROLLMENT_PI_ANCHOR_CERT_PORT:-54732}"
...
echo "--- applying process_instances ---"
run_sql "$ROOT/supabase/migrations/20260713000000_process_instances.sql"

echo "--- applying the D-95 process-instance anchor migration ---"
run_sql "$ROOT/supabase/migrations/20260815160000_form_packet_session_process_instance_anchor.sql"

echo "--- D-95 anchor invariant assertions ---"
run_sql "$CERT_DIR/01_anchor_invariants.sql"
